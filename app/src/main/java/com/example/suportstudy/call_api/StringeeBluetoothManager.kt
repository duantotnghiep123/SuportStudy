...
object StringeeBluetoothManager {
    private  val BLUETOOTH_SCO_TIMEOUT_MS = 4000
    ...
    var stringeeAudioManager: StringeeAudioManager? = null
     ...
     */
    private class BluetoothServiceListener : ServiceListener {
    ...
    fun create(context: Context, audioManager: StringeeAudioManager?): StringeeBluetoothManager? {
        return create(context, audioManager)
    }

     fun StringeeBluetoothManager(mcontext: Context, audioManager: StringeeAudioManager?) {
        ThreadUtils.checkIsOnMainThread()
        context = mcontext
        stringeeAudioManager = audioManager
        this.audioManager = getAudioManager(mcontext)
